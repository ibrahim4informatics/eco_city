        ...
        <Box display={"flex"} px={2} py={4} justifyContent={"center"} id="intro" w={"100%"} minHeight={"100dvh"}>
            ...
            <Box w={"100%"} gap={4} maxW={1204} display={"flex"} flexDir={{ base: "column", lg: "row" }}>
                ...
                <Box flex={1}>
                    ...
                    <Image initial={{ scale: 0.5, opacity: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.3 }} src={wasteBins} h={200} my={4} rounded={"md"} shadow={"md"} w={"full"} />
                </Box>

                <Box flex={1}>
                    <Image initial={{ scale: 0.5, opacity: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.1 }} src={wasteManagementEffectPicture} rounded={"md"} shadow={"md"} w={"full"} />
                    ...
                    <Image initial={{ scale: 0.5, opacity: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.1 }} src={cartoonCharacter1} rounded={"md"} w={400} mx={"auto"} />
