...
const HeroSection = () => {
    return (
        <Box pos={"relative"} w={"full"} h={"100dvh"} display={"flex"} alignItems={"center"} justifyContent={"center"}>
            ...
            <video muted autoPlay playsInline style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100dvh", objectFit: "cover" }}>
